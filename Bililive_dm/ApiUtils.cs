...
namespace Bililive_dm
{
    ...
    internal static class ApiUtils
    {
        ...
        private static string ComputeSign(string text)
        {
            ...
            hash = _md5.ComputeHash(Encoding.UTF8.GetBytes(text + "60698ba2f68e01ce44738920a0ffe768"));
            ...
            using (MemoryStream stream = new MemoryStream(Convert.FromBase64String(publicKey)))
            {
                using (BinaryReader reader = new BinaryReader(stream))
                {
                    ...
                    else if (i16 == 0x8202)
                    {
                        ...
                        throw new ArgumentException(nameof(publicKey));
                    modulusLength = System.BitConverter.ToInt32(new byte[] { low, high, 0x00, 0x00 }, 0);
