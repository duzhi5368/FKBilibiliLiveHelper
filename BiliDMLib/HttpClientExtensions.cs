...
namespace System.Extensions
{
    ...
    public static class HttpClientExtensions
    {
        ...
        public static Task<HttpResponseMessage> SendAsync(this HttpClient client, HttpMethod method,
            string url, IEnumerable<KeyValuePair<string, string>> queries,
            IEnumerable<KeyValuePair<string, string>> headers,
            string cookie, string content, string contentType)
        {
